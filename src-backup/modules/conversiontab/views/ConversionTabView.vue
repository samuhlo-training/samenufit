<template>
  <div class="container mx-auto flex flex-col justify-center items-center">
    <h1 class="text-4xl mona-sans-custom ml-7 uppercase font-bold mb-7">CHULETA CANTIDADES</h1>

    <!-- Texto y flecha rosa -->

    <div class="bg-[#fff3e3] rounded-lg shadow-sm p-7 w-full max-w-3xl mt-8">
